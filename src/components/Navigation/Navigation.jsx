  ...
  return (
    <Navbar bg="light" expand="lg" className="nav">
      <Container>
        ...
        <AiOutlineSearch size="25px" />Serach facebook
        </div>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-5 align-items-center">
            <Nav.Link href="/home"  className="homies"><AiFillHome className="text-primary mx-4 "size="30px" /></Nav.Link>
            <Nav.Link href="/video"  className="homies"><PiVideoFill className="mx-4 "size="30px" /></Nav.Link>
            <Nav.Link href="/store"  className="homies"><IoStorefrontOutline size="30px" className="text-dark mx-4"/></Nav.Link>
            <Nav.Link href="/friend" className="homies"><MdOutlineGroup size="30px" className="mx-4"/></Nav.Link>
            <Nav.Link href="/group" className="homies"><MdGroups2 size="30px" className="mx-4"/></Nav.Link>
          </Nav>
        </Navbar.Collapse>
